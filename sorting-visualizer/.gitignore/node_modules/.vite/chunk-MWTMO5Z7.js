...
function useSynchronousEffect(func, values2) {
  var key = import_react2.default.useRef([]);
  var output;
  var currentKey = import_react2.default.useMemo(function() {
    return {};
  }, values2);
...
function makeStyles(stylesOrCreator) {
  ...
  var useStyles = function useStyles2() {
    ...
    var stylesOptions = _extends({}, import_react2.default.useContext(StylesContext), stylesOptions2);
    var instance = import_react2.default.useRef();
    var shouldUpdate = import_react2.default.useRef();
    ...
    if (true) {
      import_react2.default.useDebugValue(classes);
    }
    return classes;
  };
  return useStyles;
...
var withStyles = function withStyles2(stylesOrCreator) {
  ...
  return function(Component) {
    ...
    var WithStyles = import_react.default.forwardRef(function WithStyles2(props, ref) {
...
//# sourceMappingURL=chunk-MWTMO5Z7.js.map
